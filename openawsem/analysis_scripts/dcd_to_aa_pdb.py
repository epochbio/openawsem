...
parser.add_argument("-dp",
                    "--dcd_pattern",
                    default="replica*.dcd",
                    help="pattern to search for DCD files for. Default='replica*.dcd'. Additional '.'s in the name may cause errors")
...
for file in dcd_files:
    ...
    traj = md.load(f'{file_name}.dcd', top='crystal_structure-openmmawsem.pdb')
